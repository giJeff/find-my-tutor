									...
									<form:form method="POST" modelAttribute="user"
										...
										<div class="paper-row">
											<div class="form-group row">
												<label
													class="col-md-3 col-sm-5 col-form-label"
											...
											<div class="form-group row">
												...
												<div class="col-sm-5">
													<c:choose>
														...
														<c:otherwise>
															<form:select path="roleProfiles" multiple="false"
																class="form-control input-sm">
											...
											<div class="paper-row">
												<div class="form-group row">
													<c:choose>
														<c:when test="${edit}">
															<label for="Update"
																class="col-md-3 col-sm-5 col-xs-12 col-form-label">Update:</label>
														...
														<c:otherwise>
															<label for="Register"
																class="col-md-3 col-sm-5 col-xs-12 col-form-label">Register:</label>
															<div class="col-sm-5 col-xs-10">
																<input type="submit"
																	class="btn btn-block btn-primary btn-default"
																	value="Register">
											...
											<div class="paper-row">
												<div class="form-group row">
													<c:choose>
														<c:when test="${edit}">
															<label for="Back"
																class="col-md-3 col-sm-5 col-xs-12 col-form-label">Back:</label>
															<div class="col-sm-5 col-xs-10">
														...
														<c:otherwise>
															<label for="Cancel"
																class="col-md-3 col-sm-5 col-xs-12 col-form-label">Cancel:</label>
															<div class="col-sm-5 col-xs-10">
